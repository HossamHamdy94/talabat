 ...
 * Use the [CanceledFragment.newInstance] factory method to
...
class CanceledFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        list.add(0,ListItem(R.drawable.type_car,"أريد مساعده","منذ يوم", "ذكر", "في المنزل", "5"))
